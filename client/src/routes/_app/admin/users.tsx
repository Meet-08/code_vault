            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="h-11 rounded-xl border border-border-base/80 bg-bg-subtle/90 px-4 text-sm text-text-primary outline-none transition-colors focus:border-accent-400/60"
                >
